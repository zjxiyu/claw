import { useRouter , Zap, Shield, BookOpen, TrendingUp, ChevronRight } from "next/navigation"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-bold text-gray-900">智能体行为准则</h3>
            <button 
              onClick={() => router.push('/agent-rules')}
              className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center"
            >
              查看完整准则 <ChevronRight className="w-4 h-4 ml-1" />
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* 核心原则卡片 */}
            <div 
              className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-5 border border-blue-200 cursor-pointer hover:shadow-md transition-shadow"
              onClick={() => router.push('/agent-rules#core')}
            >
              <div className="flex items-center mb-3">
                ...
                <div>
                  <h4 className="font-bold text-blue-900">快准狠</h4>
                  <p className="text-xs text-blue-700">找到最短路径，一次成功</p>
                </div>
              </div>
              <p className="text-sm text-blue-800">交付结果，不重复试错，不绕弯路</p>
            </div>

            {/* 守承诺卡片 */}
            <div 
              className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-5 border border-purple-200 cursor-pointer hover:shadow-md transition-shadow"
              onClick={() => router.push('/agent-rules#promise')}
            >
              <div className="flex items-center mb-3">
                ...
                <div>
                  <h4 className="font-bold text-purple-900">守承诺</h4>
                  <p className="text-xs text-purple-700">说到做到，标准一致</p>
                </div>
              </div>
              <p className="text-sm text-purple-800">不偷工减料，保证质量，兑现承诺</p>
            </div>

            {/* 常学习卡片 */}
            <div 
              className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-5 border border-green-200 cursor-pointer hover:shadow-md transition-shadow"
              onClick={() => router.push('/agent-rules#learn')}
            >
              <div className="flex items-center mb-3">
                ...
                <div>
                  <h4 className="font-bold text-green-900">常学习</h4>
                  <p className="text-xs text-green-700">从错误中学习</p>
                </div>
              </div>
              <p className="text-sm text-green-800">每日进步，不重复犯错，记录教训</p>
            </div>

            {/* 高纬度商业思维卡片 */}
            <div 
              className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-5 border border-orange-200 cursor-pointer hover:shadow-md transition-shadow"
              onClick={() => router.push('/agent-rules#business')}
            >
              <div className="flex items-center mb-3">
                ...
                <div>
                  <h4 className="font-bold text-orange-900">商业思维</h4>
                  <p className="text-xs text-orange-700">创造价值</p>
                </div>
              </div>
              <p className="text-sm text-orange-800">赚钱养我，技术服务于商业目的</p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
              ...
              <div className="text-sm text-gray-600">核心原则</div>
            </div>
            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
              <div className="text-2xl font-bold text-red-600">9</div>
              <div className="text-sm text-gray-600">错误避免</div>
            </div>
            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
              <div className="text-2xl font-bold text-green-600">7</div>
              <div className="text-sm text-gray-600">执行标准</div>
            </div>
            <div className="text-center p-4 bg-white rounded-lg border border-gray-200">
              <div className="text-2xl font-bold text-yellow-600">4</div>
              <div className="text-sm text-gray-600">关键教导</div>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <button
              onClick={() => router.push('/agent-rules')}
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-medium rounded-lg hover:from-blue-600 hover:to-purple-700"
            >
